						...
						<c:forEach var="aluno" items="${lista}">
							<tr>
								...
								<td class="actions"><a class="btn btn-success btn-xs"
									href="controller.do?command=VisualizarAluno&id=${aluno.id}">Visualizar</a>
									<a class="btn btn-warning btn-xs"
									href="controller.do?command=EditarAluno&id=${aluno.id}">Editar</a>
